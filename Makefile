# This Makefile is for the HTTP::File extension to perl.
#
...
#
#   MakeMaker ARGV: (q[PREFIX=/usr/end70/mnt/admin/perl/HTTP-File-1.00/..])
#
#   MakeMaker Parameters:

#	NAME => q[HTTP::File]
#	PREREQ_PM => { HTTP::Headers::UserAgent=>q[1.00] }
#	VERSION_FROM => q[File.pm]
...
PREFIX = /usr/end70/mnt/admin/perl/HTTP-File-1.00/..
INSTALLDIRS = site
INSTALLPRIVLIB = $(PREFIX)/lib/5.00503
INSTALLARCHLIB = $(PREFIX)/lib/5.00503/i386-linux
INSTALLSITELIB = $(PREFIX)/lib/site_perl/5.005
INSTALLSITEARCH = $(PREFIX)/lib/site_perl/5.005/i386-linux
...
manifypods : pure_all File.pm
	@$(POD2MAN) \
	File.pm \
	$(INST_MAN3DIR)/HTTP::File.$(MAN3EXT)
...
Makefile : Makefile.PL $(CONFIGDEP)
	...
	$(PERL) "-I$(PERL_ARCHLIB)" "-I$(PERL_LIB)" Makefile.PL "PREFIX=/usr/end70/mnt/admin/perl/HTTP-File-1.00/.."
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"HTTP-File\" VERSION=\"1,00,0,0\">\n}. qq{\t<TITLE>HTTP-File</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"HTTP-Headers-UserAgent\" VERSION=\"1,00,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > HTTP-File.ppd
